...
Edit "appSettings.json" to change the "appAccessKey" from the demo to something secure. You can run test pages on a local machine. You need to run as a hosted website to run devices as robot clients, or to operate robots.
